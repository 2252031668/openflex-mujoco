...
做法（纯 XML 手术，不依赖 packages/ 子模块，直接读已提交的自碰撞成品）：
 ...
 3. 把手根 body（ldjy_<side>_palm）以 pos="0 0 0.1415"（手掌背面手腕安装平面对齐 link7 电机端面 z≈0.1105）挂到
...
# 手掌网格背面（手腕安装平面）在本地 z≈-0.031，故 palm 原点放在 0.1105 + 0.031 = 0.1415，
# 让安装平面与电机端面贴合，不再嵌入电机壳内部（原 0.1311 时仍嵌入 0.0104m）。
WRIST_POS = "0 0 0.1415"
